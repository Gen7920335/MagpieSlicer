...
- Public application, installer, release, and Git tag version: `2.5.0.0.1`
- Git tag: `v2.5.0.0.1`
- Installer: `MagpieSlicer_Windows_Installer_V2.5.0.0.1_x64.exe`
- Internal SemVer-compatible Orca version: `2.5.0-modified.0.1`
- Windows numeric file version: `2.5.0.1`

Windows executable metadata permits four numeric fields, so its final field
encodes `Magpie line * 1000 + Magpie revision`. This gives `1` for Magpie
sequence `0.1` while the public version remains the full five-field value.
