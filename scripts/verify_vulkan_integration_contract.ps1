...
Require-Text $tree 'VulkanAabbBatch gpu_tree_batch'
Require-Text $tree 'mst_line_x_layer_contour_cache.insert({ line, false })'
Require-Text $tree 'dispatch_indexed_aabb_candidates'
...
Require-Text $cura 'VulkanAabbOperation::CuraSupport'
Require-Text $cura 'polygons_may_overlap(support, geometry.xy_gap_bounds[layer_idx])'
