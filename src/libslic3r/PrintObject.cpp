    ...
    for (const t_config_option_key &opt_key : opt_keys) {
        if (   opt_key == "brim_width"
	       ...
	       opt_key == "support_type"
            ...
            || opt_key == "support_interface_sublayer_pattern"
            || opt_key == "support_interface_sublayer_start_layer"
            || opt_key == "support_interface_sublayer_end_layer"
            || opt_key == "support_interface_sublayer_pattern_type"
            || opt_key == "support_interface_sublayer_angle"
            || opt_key == "support_interface_sublayer_temperature"
