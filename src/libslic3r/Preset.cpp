...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "nozzle_type", "nozzle_hrc","auxiliary_fan",
    "support_interface_cooling_position", "support_interface_brush_start", "support_interface_brush_end",
    "support_interface_brush_repetitions", "support_interface_brush_speed",
    "nozzle_volume","upward_compatible_machine", "z_hop_types", "travel_slope", "retract_lift_enforce","support_chamber_temp_control","support_air_filtration","printer_structure",
