...
void Sidebar::priv::flush_printer_sync(bool restart)
{
    ...
    //btn_sync_printer->SetBackgroundColorNormal((*counter_sync_printer & 1) ? "#F8F8F8" :"#398FF4");
...
{
    StateColor not_synced_colour(std::pair<wxColour, int>(wxColour("#398FF4"), StateColor::Normal));
    ...
    : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxSize(39 * wxGetApp().em_unit(), -1)), p(new priv(parent))
{
    ...
    // add printer
    {
        ...
        struct PanelColors {
            ...
            wxColour bg_focus  = "#EBF4FE";
            wxColour bd_normal = "#DBDBDB";
            wxColour bd_hover  = "#398FF4";
            wxColour bd_focus  = "#398FF4";
        };
        ...
        */
        ...
        StateColor btn_sync_bd_col(
                std::pair<wxColour, int>(wxColour("#398FF4"), StateColor::Pressed),
                std::pair<wxColour, int>(wxColour("#398FF4"), StateColor::Hovered),
    ...
    text_ctrl->Bind(wxEVT_SET_FOCUS, [this](wxFocusEvent& e) {
        ...
        p->m_search_bar->SetBorderColor(wxColour("#398FF4"));
...
void Plater::calib_lesic(const Calib_Params& params)
{
    ...
    const LesicCalibrationLayout lesic_layout = make_lesic_calibration_layout(
        bed_ext.size().x(), bed_ext.size().y(), nozzle_diameter, params);
    const double line_width = lesic_layout.line_width;
    const double layer_height = lesic_layout.layer_height;
    const double desired_height = lesic_layout.model_height;
    const double circle_diameter = lesic_layout.circle_diameter;
    ...
    new_params.lesic_small_bed = lesic_layout.small_bed;
