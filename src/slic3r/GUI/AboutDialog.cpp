...
wxString CopyrightsDialog::get_html_text()
{
    ...
    wxString text = wxString::Format(
        ...
        _L("License"),
        _L("Magpie Slicer is licensed under "),
        "https://www.gnu.org/licenses/agpl-3.0.html",_L("GNU Affero General Public License, version 3"),
        _L("Magpie Slicer is based on OrcaSlicer, PrusaSlicer, and BambuStudio"),
        _L("Libraries"),
        ...
        wxDefaultSize, /*wxCAPTION*/wxDEFAULT_DIALOG_STYLE)
{
    ...
    // logo
    m_logo_bitmap = ScalableBitmap(this, is_dark ? "MagpieSlicer_about_dark" : "MagpieSlicer_about", 125);
    ...
    // version
    {
        ...
        auto          version_string = std::string(SLIC3R_DISPLAY_VERSION);
    ...
    m_html = new wxHtmlWindow(this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxHW_SCROLLBAR_NEVER /*NEVER*/);
      {
          ...
          const auto text = from_u8(
              ...
              "<html>"
              "<body>"
              "<p style=\"text-align:left\"><a style=\"color:#398FF4\" href=\"https://www.orcaslicer.com\">https://www.orcaslicer.com</ a></p>"
              "</body>"
              "</html>")
            ).str());
          m_html->SetPage(text);
