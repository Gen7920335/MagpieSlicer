	...
	, m_notification_start  (GLCanvas3D::timestamp_now())
{
    ...
    m_HyperTextColor = ImGuiWrapper::COL_ORCA;
}
...
void NotificationManager::PopNotification::use_bbl_theme()
{
 ...
 //   OldStyle.Colors[ImGuiCol_Text]     = m_TextColor;
	...
	m_HyperTextColor = ImGuiWrapper::COL_ORCA;
	m_HyperTextColorHover = m_is_dark ? ImVec4(90.f / 255.f, 168.f / 255.f, 255.f / 255.f, 1) : ImVec4(51.f / 255.f, 121.f / 255.f, 201.f / 255.f, 1); //#5AA8FF / #3379C9;
