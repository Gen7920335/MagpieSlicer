...
void GLCanvas3D::LayersEditing::render_variable_layer_height_dialog(GLCanvas3D& canvas) {
    ...
    ImGui::PushStyleColor(ImGuiCol_SliderGrabActive, ImGuiWrapper::COL_ORCA);
    ...
    ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(ImGuiWrapper::COL_ORCA.x, ImGuiWrapper::COL_ORCA.y, ImGuiWrapper::COL_ORCA.z, 0.0f));
    ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(ImGuiWrapper::COL_ORCA.x, ImGuiWrapper::COL_ORCA.y, ImGuiWrapper::COL_ORCA.z, 0.0f));
...
void GLCanvas3D::_render_imgui_select_plate_toolbar()
{
    ...
    if(m_sel_plate_toolbar.show_stats_item)
    {
        ...
        if (all_plates_stats_item->slice_state == IMToolbarItem::SliceState::UNSLICED || all_plates_stats_item->slice_state == IMToolbarItem::SliceState::SLICING) {
            ...
            ImGui::GetWindowDrawList()->AddRectFilled(bar_bg_bgn, bar_fg_end, IM_COL32(57, 143, 244, 255),   bar_size.y); // BAR PROGRESS
        }
        else if (all_plates_stats_item->slice_state == IMToolbarItem::SliceState::SLICE_FAILED) {
