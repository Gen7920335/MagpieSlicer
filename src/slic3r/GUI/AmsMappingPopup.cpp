...
void AmsReplaceMaterialDialog::create()
{
    ...
    identical_filament->SetForegroundColour(StateColor::darkModeColorFor(wxColour("#398FF4")));
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(39, 98, 166), StateColor::Pressed), std::pair<wxColour, int>(wxColour(57, 143, 244), StateColor::Normal));
