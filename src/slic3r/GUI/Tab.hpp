...
public:
	...
	ConfigOptionsGroupShp	new_optgroup(const wxString& title, const wxString& icon = wxEmptyString, int noncommon_label_width = -1,
...
protected:
	...
	void			load_key_value(const std::string& opt_key, const std::vector<std::string>& values);
