    ...
    const bool grayscale/* = false*/, const bool dark_mode/* = false*/, const std::string& new_color /*= ""*/, const float scale_in_center/* = 0*/)
{
    ...
    replaces["\"#0x00AE42\""] = "\"#398FF4\"";
    replaces["\"#00FF00\""] = "\"#5AA8FF\"";
    if (dark_mode) {
        replaces["\"#262E30\""] = "\"#EFEFF0\"";
        replaces["\"#323A3D\""] = "\"#B3B3B5\"";
        replaces["\"#808080\""] = "\"#818183\"";
        //replaces["\"#ACACAC\""] = "\"#54545A\"";
        replaces["\"#CECECE\""] = "\"#505B6A\"";
        replaces["\"#6B6B6B\""] = "\"#818182\"";
        replaces["\"#909090\""] = "\"#FFFFFF\"";
        replaces["\"#00FF00\""] = "\"#3379C9\"";
        replaces["\"#398FF4\""] = "\"#2762A6\"";
        replaces["\"#F1F1F1\""] = "\"#343B47\"";
        replaces["#DBDBDB"] = "#46515F"; // ORCA border color
        replaces["#F0F0F1"] = "#303844"; // ORCA disabled background color
...
bool BitmapCache::load_from_svg_file_change_color(const std::string &filename, unsigned width, unsigned height, ImTextureID &texture_id, const char *hexColor)
{
    ...
    if (hexColor == nullptr || !parse_color4(hexColor, replacement)) {
        nsvgDelete(image);
        return false;
    }
    const unsigned int change_color = unsigned(replacement[0]) |
        (unsigned(replacement[1]) << 8) |
        (unsigned(replacement[2]) << 16) |
        (unsigned(replacement[3]) << 24);
    unsigned int green_color = 0xFFF48F39; // #398FF4
