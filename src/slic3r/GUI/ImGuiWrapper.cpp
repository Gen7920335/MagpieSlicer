...
const ImVec4 ImGuiWrapper::COL_GREEN_LIGHT       = { 57 / 255.f, 143 / 255.f, 244 / 255.f, 0.25f };
...
const ImVec4 ImGuiWrapper::COL_ORCA              = { 57 / 255.f, 143 / 255.f, 244 / 255.f, 1.f };
const ImVec4 ImGuiWrapper::COL_ORCA_DARK         = { 39 / 255.f, 98  / 255.f, 166 / 255.f, 1.f };
const ImVec4 ImGuiWrapper::COL_ORCA_HOVER        = { 90 / 255.f, 168 / 255.f, 255 / 255.f, 1.f };
const ImVec4 ImGuiWrapper::COL_ORCA_HOVER_DARK   = { 51 / 255.f, 121 / 255.f, 201 / 255.f, 1.f };
...
bool ImGuiWrapper::bbl_slider_float_style(const std::string &label, float *v, float v_min, float v_max, const char *format, float power, bool clamp, const wxString &tooltip)
{
    ...
    ImGui::PushStyleColor(ImGuiCol_SliderGrabActive, COL_ORCA);
...
bool ImGuiWrapper::bbl_checkbox(const wxString &label, bool &value)
{
    ...
    bool b_value = value;
    if (b_value) {
        ImGui::PushStyleColor(ImGuiCol_FrameBg, COL_ORCA);
        ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, COL_ORCA);
        ImGui::PushStyleColor(ImGuiCol_FrameBgActive, COL_ORCA);
    }
    auto label_utf8 = into_u8(label);
...
void ImGuiWrapper::push_menu_style(const float scale)
{
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleColor(ImGuiCol_HeaderHovered, COL_ORCA);
...
void ImGuiWrapper::push_common_window_style(const float scale) {
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleColor(ImGuiCol_Separator, ImGuiWrapper::COL_SEPARATOR_DARK);                             // 5
        ImGui::PushStyleColor(ImGuiCol_Button, ImVec4(1.00f, 1.00f, 1.00f, 1.00f));                              // 6
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, COL_ORCA);                                                // 7
        ImGui::PushStyleColor(ImGuiCol_ButtonActive, COL_ORCA);                                                 // 8
        ImGui::PushStyleColor(ImGuiCol_FrameBgHovered, ImVec4(84 / 255.0f, 84 / 255.0f, 90 / 255.0f, 1.00f));    // 9
        ImGui::PushStyleColor(ImGuiCol_FrameBgActive, ImVec4(62 / 255.0f, 62 / 255.0f, 69 / 255.0f, 1.00f));     // 10
        ImGui::PushStyleColor(ImGuiCol_FrameBg, ImVec4(238 / 255.0f, 238 / 255.0f, 238 / 255.0f, 0.00f));        // 11
        ...
        ImGui::PushStyleColor(ImGuiCol_PlotHistogram, COL_ORCA);                                                // 14
    }
    else {
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 1.0f * scale);
        ImGui::PushStyleVar(ImGuiStyleVar_WindowPadding, ImVec2(20.0f, 10.0f) * scale);
...
void ImGuiWrapper::push_confirm_button_style() {
    if (m_is_dark_mode) {
        ImGui::PushStyleColor(ImGuiCol_Button,        to_ImVec4(decode_color_to_float_array("#2762A6")));
        ImGui::PushStyleColor(ImGuiCol_Border, COL_ORCA);
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, to_ImVec4(decode_color_to_float_array("#3379C9")));
        ImGui::PushStyleColor(ImGuiCol_ButtonActive,  to_ImVec4(decode_color_to_float_array("#2762A6")));
        ...
        ImGui::PushStyleColor(ImGuiCol_Button,        to_ImVec4(decode_color_to_float_array("#398FF4")));
        ImGui::PushStyleColor(ImGuiCol_Border, COL_ORCA);
        ImGui::PushStyleColor(ImGuiCol_ButtonHovered, to_ImVec4(decode_color_to_float_array("#5AA8FF")));
        ImGui::PushStyleColor(ImGuiCol_ButtonActive,  to_ImVec4(decode_color_to_float_array("#398FF4")));
...
void ImGuiWrapper::push_combo_style(const float scale)
{
    if (m_is_dark_mode) {
        ...
        ImGui::PushStyleVar(ImGuiStyleVar_FrameBorderSize, 1.0f * scale);
        ImGui::PushStyleColor(ImGuiCol_PopupBg, ImGuiWrapper::COL_WINDOW_BG_DARK);
        ImGui::PushStyleColor(ImGuiCol_BorderActive, ImVec4(COL_ORCA.x, COL_ORCA.y, COL_ORCA.z, 0.6f));
        ImGui::PushStyleColor(ImGuiCol_HeaderHovered, {0.f, 0.f, 0.f, 0.f});                            // ORCA hovered item background color
        ImGui::PushStyleColor(ImGuiCol_HeaderActive, COL_ORCA);
        ImGui::PushStyleColor(ImGuiCol_Header, ImVec4(COL_ORCA.x, COL_ORCA.y, COL_ORCA.z, 0.25f));
...
void ImGuiWrapper::push_radio_style(const float scale)
{
    ...
    if (m_is_dark_mode) {
        ImGui::PushStyleColor(ImGuiCol_CheckMark, to_ImVec4(decode_color_to_float_array("#398FF4"))); // ORCA use orca color for radio buttons
