...
void MsgDialog::apply_style(long style)
{
    ...
    logo->SetBitmap( create_scaled_bitmap(style & wxAPPLY        ? "completed" :
                                          ...
                                          style & wxICON_QUESTION       ? "question"    : "MagpieSlicer", this, 64, style & wxICON_ERROR));
}
                            ...
                            std::function<void(const wxString &)> link_callback = nullptr)
{
    ...
    if (!link_text.IsEmpty() && link_callback) {
        msg_escaped += "<span><a href=\"#\" style=\"color:rgb(57, 143, 244); text-decoration:underline;\">" + std::string(link_text.ToUTF8().data()) + "</a></span>";
    }
    ...
    , msg(temp_msg)
{
	...
	logo->SetBitmap(create_scaled_bitmap("MagpieSlicer_192px_grayscale.png", this, monospaced_font ? 48 : /*1*/64));
...
wxBoxSizer *Newer3mfVersionDialog::get_msg_sizer()
{
    ...
    if (file_version_newer) { 
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3MF file version is in Beta and it is newer than the current Magpie Slicer version."));
        wxStaticText *   text2       = new wxStaticText(this, wxID_ANY, _L("If you would like to try a newer Magpie Slicer build, you may click to"));
        ...
        text1 = new wxStaticText(this, wxID_ANY, _L("The 3MF file version is newer than the current Magpie Slicer version."));
        wxStaticText *text2 = new wxStaticText(this, wxID_ANY, _L("Updating Magpie Slicer could enable all functionality in the 3MF file."));
        horizontal_sizer->Add(text2, 0, wxEXPAND, 0);
    }
