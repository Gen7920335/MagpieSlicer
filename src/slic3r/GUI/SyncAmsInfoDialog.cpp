    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    // icon
    std::string icon_path = (boost::format("%1%/images/MagpieSlicerTitle.ico") % resources_dir()).str();
   ...
   // m_sizer_main->Add(m_basic_panel, 0, wxEXPAND | wxLEFT | wxRIGHT, FromDIP(15));
    ...
    {//new content//tip confirm ok button
        ...
        m_more_setting_tips->SetForegroundColour(wxColour(39, 98, 166));
        ...
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(39, 98, 166), StateColor::Pressed), std::pair<wxColour, int>(wxColour(90, 168, 255), StateColor::Hovered),
...
void SyncAmsInfoDialog::Enable_Auto_Refill(bool enable)
{
    ...
    if (enable) {
        m_ams_backup_tip->SetForegroundColour(wxColour("#398FF4"));
    } else {
