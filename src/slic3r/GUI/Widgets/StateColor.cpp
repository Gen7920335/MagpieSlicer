...
static std::map<wxColour, wxColour> gDarkColors{
    {"#398FF4", "#2762A6"}, // rgb(57, 143, 244)    ORCA color
    ...
    {"#DFDFDF", "#3A4351"}, // rgb(223, 223, 223)  Button Background color
    {"#D4D4D4", "#485362"}, // rgb(212, 212, 212)  Button Background color on Hover
    {"#6B6A6A", "#909090"}, // rgb(107, 107, 106)  Button Dimmed text
    {"#5AA8FF", "#3379C9"}, // rgb(57, 143, 244)    Button Confirm Color hover | ORCA Color Hover
    ...
    {"#EEEEEE", "#485463"}, // rgb(238, 238, 238)  Separator Line | Title Line Color
    {"#E8E8E8", "#3A4351"}, // rgb(232, 232, 232)  ???
    {"#323A3D", "#E5E5E4"}, // rgb(50, 58, 61)     Softer text color
    {"#FFFFFF", "#292E38"}, // rgb(255, 255, 255)  Window background
    {"#F8F8F8", "#343B48"}, // rgb(248, 248, 248)  Sidebar > Titlebar > Gradient Top | BBL monitor page titlebar bg
    {"#F1F1F1", "#343B47"}, // rgb(241, 241, 241)  Sidebar > Titlebar > Gradient Bottom
    {"#3B4446", "#292E37"}, // rgb(59, 68, 78)     Top Bar / Main tab bar bg color
    {"#CECECE", "#505B6A"}, // rgb(206, 206, 206)  Sidebar wxPanel bg |
    {"#000000", "#FFFFFE"}, // rgb(0, 0, 0)        Mostly Text color wxBlack
    {"#F4F4F4", "#343B49"}, // rgb(244, 244, 244)  ???
    {"#DBDBDB", "#46515F"}, // rgb(219, 219, 219)  Input/Combo Box Border Color
    ...
    {"#FEFFFF", "#222832"}, // rgb(254, 255, 255)  Side Tabbar bg |
    {"#A6A9AA", "#2B2F38"}, // rgb(166, 169, 170)  Seperator color
    {"#363636", "#B2B3B5"}, // rgb(54, 54, 54)     Sidebar > Parameter Label/Title color | Sidebar tab text | Create Filament window text
    {"#F0F0F1", "#303844"}, // rgb(240, 240, 241)  Disabled element background // ORCA Used better background color for dark mode
    {"#9E9E9E", "#4F5A69"}, // rgb(158, 158, 158)  ???
    {"#D7E8DE", "#202B38"}, // rgb(215, 232, 222)  Not Used anymore // Leftover from BBS
    {"#2B3436", "#808080"}, // rgb(43, 52, 54)     Not Used anymore // Leftover from BBS. Was used as main fill color of icons
    {"#ABABAB", "#ABABAB"},
    {"#D9D9D9", "#252B34"}, // rgb(217, 217, 217)  Sidebar > Toggle button track color
    {"#FFFEFE", "#D9D9D9"}, // rgb(255, 254, 254)  Sidebar > Toggle button thumb color
    //{"#F0F0F0", "#4C4C54"},
    // ORCA
    {"#D7E9FD", "#24364A"}, // rgb(191, 225, 222)  Dropdown checked item background color > ORCA color with %25 opacity
    {"#EBF4FE", "#283542"}, // rgb(229, 240, 238)  Combo / Dropdown focused background color > ORCA color with %10 opacity
};
