    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0x398FF4, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#398FF4", "#398FF4"};
wxString btn_confirm[10]  = {"#DFDFDF", "#398FF4", "#5AA8FF", "#398FF4", "#398FF4", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#398FF4", "#76B7FF"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#398FF4", "#398FF4"};
