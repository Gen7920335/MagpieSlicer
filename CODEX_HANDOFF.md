...
- **Next step — snug overhang, the last failing fixture.** Its 1.84 mm2 is collision-limited under rigid parallelism: a column at (15.5, 0) r=2.5 blocks the only approach, and no detour is permitted. It is untouched by every change in this round. Deciding it needs the contract question answered — whether a branch may deviate from parallel to clear an obstacle, or whether that demand belongs to Micro Branch or to a second trunk.
